                ...
                <!--div class="btn-group btn-group-list btn-group-notification">
                    ...
                    <div class="dropdown-menu pull-right">
                      ...
                      <ul class="media-list dropdown-list">
                          <li class="media">
                            <img class="img-circle pull-left noti-thumb" src="<?= $path ?>images/photos/user1.png" alt="">
                          ...
                          <li class="media">
                            <img class="img-circle pull-left noti-thumb" src="<?= $path ?>images/photos/user2.png" alt="">
                            <div class="media-body">
                          ...
                          <li class="media">
                            <img class="img-circle pull-left noti-thumb" src="<?= $path ?>images/photos/user3.png" alt="">
                            <div class="media-body">
                          ...
                          <li class="media">
                            <img class="img-circle pull-left noti-thumb" src="<?= $path ?>images/photos/user4.png" alt="">
                            <div class="media-body">
